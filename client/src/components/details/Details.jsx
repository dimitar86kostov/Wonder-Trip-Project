...
import DetailsComments from "./comments/detailsComments/DetailsComments";
import EditComment from "./comments/editComment/EditComment";

export default function TripDetails() {
    const { tripId } = useParams();
    const { userId } = useAuthContext();
    const [trip, setTrip, setTripHandler, isFetching] = useGetOneTrips(tripId);

    const onSetTripHandler = (trip) => {
        setTripHandler(trip);
    }
    ...
    const isOwner = trip._ownerId === userId;
      ...
      return (
        <>
            <Routes>
                <Route path="comment/:commentId/edit" element={<EditComment setTrip={onSetTripHandler} />} />
            </Routes>
