    ...
    return (
        <>
            ...
            <div className="details-comments">
                <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Comments:</h2>
                <ul>
                    <div className="border-t border-gray-200 pt-4">
                        <dt className="font-medium text-gray-900">I was there! It's amazing!</dt>
                        <dd className="mt-2 text-sm text-gray-500">Jak</dd>
                    </div>
                    <div className="border-t border-gray-200 pt-4">
                        <dt className="font-medium text-gray-900">Very expenssive hotels!</dt>
                        <dd className="mt-2 text-sm text-gray-500">Pesho</dd>
                    </div>
                </ul>
            </div>
            {/* text area */}
