            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div
                    ...
                    <h5 className="block font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-white">
                        Create post with your favorite ski resort!
                    </h5>
                </div>



                <form onSubmit={submitHandler} className="flex flex-col gap-4 mt-12">
                    <div>
                    ...
                    <div className="my-3">
                        ...
                        <p className="block mb-2 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900">
                            How many km. of slopes have the ski-area
                        </p>
                        <div className="relative h-10 w-full min-w-[200px]">
                        ...
                        <p className="block mb-2 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900">
                            How many lifts have the ski area
                        </p>
                        <div className="relative h-10 w-full min-w-[200px]">
                        ...
                        <p className="block mb-2 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900">
                            How many hotels have in the resort
                        </p>
                        <div className="relative h-10 w-full min-w-[200px]">
                        ...
                        <p className="block mb-2 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900">
                            What is the daily ski pass price
                        </p>
                        <div className="relative h-10 w-full min-w-[200px]">
                        ...
                        <p className="block mb-2 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900">
                            Name and altitude of the highest peak
                        </p>
                        <div className="relative h-10 w-full min-w-[200px]">
