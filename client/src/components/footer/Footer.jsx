...
export default function Footer() {
    return (
        <footer className="w-full bg-gray-800 text-white py-2 sticky bottom-0">

            <div className="mx-auto w-full max-w-7xl px-6 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Typography variant="small" className="text-gray-300">
                        © {currentYear} Dimitar Kostov. All rights reserved.
                    </Typography>
                </div>
                ...
                <div className="flex gap-4 text-gray-400">
                    {/* Facebook */}
                    <a
                        href="https://www.facebook.com/tripbulgaria"
